...
export interface PlannerAssignment {
  "@odata.type"?: string;
  assignedBy?: { user?: { id?: string; displayName?: string } };
...
export interface PlannerTaskCard {
  ...
  progress: { percentComplete: number; label: string };
  priority: { value: number | undefined; label: string | undefined };
  startDateTime: string | null | undefined;
  dueDateTime: string | null | undefined;
  completedDateTime: string | null | undefined;
  createdDateTime: string | undefined;
  assignees: Array<{ id: string; displayName?: string | undefined; userPrincipalName?: string | undefined }>;
  labels: Array<{ category: string; label: string | null }>;
  description: string | null | undefined;
  checklist: Array<{ id: string; title: string | undefined; isChecked: boolean; orderHint: string | undefined }>;
  checklistSummary: { total: number; checked: number };
  references: Array<{ url: string; alias: string | undefined; type: string | undefined }>;
   ...
   */
  etags: { task: string | undefined; details: string | undefined };
  notes?: string[];
}
